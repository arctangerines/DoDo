     ...
     char** argv)
{
    ...
    struct dodoFileHighlights* file_hl = generate_todo_data(test_file, ck, cool_trie);
    print_todos(test_file, argv[1], file_hl, extra_lines_arg);
